...
export default class PresentationDAO {
    ...
    async save(entity) {
        ...
        if (entityFromDb == null) {
            await this.database.insert(Database.PRESENTATIONS_TABLE, data);
        } else {
            await this.database.update(Database.PRESENTATIONS_TABLE, 
                data, 
                [
